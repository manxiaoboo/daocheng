...
Page({
    ...
    onShow: function () {
        ...
        util.showBusy("读取数据");
        wx.request({
            url: config.service.host + '/question/myQuestions?page=' + that.data.page+'&id='+me.id,
            header: {
    ...
    onReachBottom: function () {
        ...
        wx.request({
            url: config.service.host + '/question/myQuestions?page=' + that.data.page+'&id='+ that.data.me.id,
            header: {
                'Authorization': 'Bearer ' + token
            },
            success: (res_questions) => {
