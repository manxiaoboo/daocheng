...
Page({
    ...
    onShow: function () {
        ...
        util.showBusy("读取数据");
        wx.request({
            url: config.service.host + '/question/allAcceptedQuestions?page=' + that.data.page + '&id='+that.data.me.expert.id,
            header: {
    ...
    onReachBottom: function () {
        ...
        wx.request({
            url: config.service.host + '/question/allOpenQuestions?page=' + that.data.page + '&id='+that.data.me.expert.id,
            header: {
                'Authorization': 'Bearer ' + token
            },
            success: (res_questions) => {
